...
function handleNewClick(){
    ...
    hideButtons();
    blankFields();
    var buttonHtml = "<buttom class=\"btn btn-primary btn-lg\" onclick=\"handleNewSave()\">Save</button>";
    buttonHtml += "<button class=\"btn btn-warning btn-lg btn-cancel\" onclick=\"handlCancelSave()\">Cancel</button>";
    document.getElementById("saveButton").innerHTML = buttonHtml;
    document.getElementById("saveButton").style.display = "inlin-block";
}
...
function makeReadOnly(){
    ...
    document.getElementById("bookAuhtor").readOnly=true;
